...
public class Dog : Animal{
	...
	new public static void Main(){
		...
		// Dog dale = new Husky("Dale"); //NOTE - If you uncomment this line and comment-out the one below, line 36 shows an error because we are treating Dale as only a dog
